...
export default [
  ...
  },
  {
    ...
    title: 'PEX@Work',
    body:
      'A campaign at PEX to increase the use of advanced platform features.',
    button: {
      txt: 'read about it',
  ...
  },
  {
    ...
    button: {
      txt: 'see more',
      href:
        'https://www.behance.net/gallery/130225307/PEX-in-the-Physical-World',
    },
  },
  {
    ...
    body:
      'Lots of original illustration work went into this fun and festive brand guide.',
    button: {
      txt: 'check it out',
      href:
        'https://www.behance.net/gallery/110753107/The-Rent-A-Christmas-Style-Guide',
    },
  },
  {
    ...
    body:
      'A collection of illustrations depicting company values and benefits. Featuring lots of elves.',
    button: {
      txt: 'elves, you say?',
      href:
        'https://www.behance.net/gallery/109998313/Rent-A-Christmas-Website-Illustrations',
    },
  },
  {
    ...
    button: {
      txt: 'check them out',
      href:
        'https://www.behance.net/gallery/109991585/Rent-A-Christmas-Business-Illustrations',
    },
  },
  {
    ...
    button: {
      txt: 'so many cards',
      href:
        'https://www.behance.net/gallery/110978231/Redesigning-the-PEX-Card',
    },
  },
  {
    ...
    button: {
      ...
      href:
        'https://www.behance.net/gallery/110980207/PEX-Card-Comps-and-Mockups',
    },
  },
  {
    ...
    button: {
      txt: 'check it out',
      href:
        'https://www.behance.net/gallery/110976955/Adding-dynamism-to-the-PEX-Brand',
    },
  },
  {
    ...
    button: {
      txt: 'check it out',
      href:
        'https://www.behance.net/gallery/111400489/Tiger-Hill-Capital-Websites',
    },
  },
  {
    ...
    body:
      'Homepage for an Investment Management firm–and a place to collect their thoughts.',
    button: {
      txt: 'check it out',
      href:
        'https://www.behance.net/gallery/111400489/Tiger-Hill-Capital-Websites',
  ...
  },
  {
    ...
    body:
      'A 220-page coffee-table book created for the 25th Annual Biotech Meeting in Laguna Beach.',
    button: {
      txt: 'flip through it',
